...
import { 
  MapPin, Star, ExternalLink, Calendar, Cloud, Users, 
  TrendingUp, Info, Sparkles, Brain, Loader2, ArrowRight 
} from 'lucide-react';
...
export default function DestinationDetailPage() {
  ...
  const generatePopularCategories = async () => {
    ...
    try {
      ...
      // Use destination's tour categories as fallback
...
// This tells Next.js to generate static pages for all destinations at build time
