...
function RestaurantsPartnerPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <Card className="shadow-xl border-2 border-amber-200">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6">
                  <strong>Customize your booking link</strong> - All restaurants are listed with BiteReserve* booking links by default 
                  (e.g., <code className="bg-gray-100 px-1 rounded">bitereserve.com/r/aw/47617</code>). With Restaurant Premium, 
                  you can change your booking link to your own website, OpenTable, Resy, or any booking platform you prefer. 
                  Plus get customizable CTAs, premium badge, and full control over your listing appearance.
                </p>
                ...
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-6 mb-6 border-2 border-amber-300">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="bg-white rounded-lg p-4 border border-amber-200 text-center">
                      ...
                      <h5 className="font-semibold text-gray-900 mb-2">Direct Bookings</h5>
                      <p className="text-xs text-gray-600">
                        Link directly to your website or booking platform instead of BiteReserve
                      </p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-amber-200 text-center">
                      ...
                      <h5 className="font-semibold text-gray-900 mb-2">Full Control</h5>
                      <p className="text-xs text-gray-600">
                        Customize button colors and CTA text to match your brand
                      </p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-amber-200 text-center">
                      ...
                      <h5 className="font-semibold text-gray-900 mb-2">Premium Badge</h5>
                      <p className="text-xs text-gray-600">
                        Stand out with a premium badge that signals quality to visitors
                      </p>
                    </div>
                  </div>
                </div>
      ...
      {/* BiteReserve Explanation */}
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <p className="text-sm text-gray-500 text-center">
          *<strong>BiteReserve</strong> is a demand-tracking platform for restaurants that helps you see where your guests actually come from by tracking calls, directions, clicks, and booking attempts.
        </p>
      </div>
    ...
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading restaurant partner page...</p>
        </div>
      </div>
    }>
