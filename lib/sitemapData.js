...
export async function getAllSitemapEntries() {
  ...
  try {
    ...
    destinations.forEach((d) => {
      if (d.slug) {
        explorePages.push({ url: `${BASE_URL}/explore/${d.slug}`, lastModified: currentDate, changeFrequency: 'weekly', priority: 0.9 });
        explorePages.push({ url: `${BASE_URL}/explore/${d.slug}/tours`, lastModified: currentDate, changeFrequency: 'weekly', priority: 0.85 });
      }
    });
