...
// Function to generate simple country data
...
const addCountrySimple = (countryName, countryImageUrl, category, destinations) => {
  try {
...
if (process.argv.length < 4) {
  console.log('\n📝 Usage: node scripts/add-country-simple.js "Country Name" "Country Image URL" "Category" "Destination1:ImageURL1" "Destination2:ImageURL2" ...');
  console.log('\n📋 Example:');
  console.log('node scripts/add-country-simple.js "Dominican Republic" "https://example.com/dr.jpg" "Caribbean" "Punta Cana:https://example.com/punta-cana.jpg" "Santo Domingo:https://example.com/santo-domingo.jpg"');
...
addCountrySimple(countryName, countryImageUrl, category, destinations); 