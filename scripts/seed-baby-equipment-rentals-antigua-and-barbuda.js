/**
 * Seed Antigua and Barbuda baby equipment rentals page data
 * Based on BabyQuip content provided by user (originally for Saint George, adapted for Antigua and Barbuda)
 *
 * Usage:
 *   node scripts/seed-baby-equipment-rentals-antigua-and-barbuda.js
 *
 * Requirements:
...
const antiguaAndBarbudaData = {
  destination_id: 'antigua-and-barbuda',
  hero_title: 'Baby Equipment Rentals in Antigua and Barbuda',
  hero_description: 'Families and little ones adore Antigua and Barbuda. Don\'t want to lug all your baby gear? No problem, we\'re here to help!',
  hero_tagline: 'Families and little ones adore Antigua and Barbuda. Don\'t want to lug all your baby gear? No problem, we\'re here to help!',
  
  // Product Categories - Based on available content for Antigua and Barbuda
  product_categories: [
    {
      name: 'Cribs & Sleep',
      icon: '🛏️',
    ...
    },
    {
      ...
      icon: '🛴',
      description: 'Lightweight strollers, jogging strollers, and wagons perfect for exploring Antigua and Barbuda with ease and comfort.',
      enabled: true,
    },
    {
      name: 'Car Seats',
    ...
    },
    {
      ...
      icon: '🏖️',
      description: 'Beach tents, sand toys, outdoor play equipment, and seasonal gear for family fun in the sun. Perfect for Antigua and Barbuda\'s 365 beaches.',
      enabled: true, // Antigua and Barbuda has beaches
    },
    {
    ...
    },
    {
      name: 'Pet Gear',
      icon: '🐾',
      description: 'Travel-friendly pet gear and accessories for your furry family members during your Antigua and Barbuda vacation.',
      enabled: true, // Mentioned in the content
    },
  ],
  ...
  // FAQs specific to Antigua and Barbuda (adapted from Saint George content)
  faqs: [
    {
    ...
    {
      question: 'How much does it cost to rent a crib in Antigua and Barbuda?',
    ...
    {
      question: 'How do I get my baby to sleep well on vacation in Antigua and Barbuda?',
  ...
  // Pricing info - Based on content: Convertible Car Seat From $25/day, Cribs $12-$22/day
  pricing_info: {
    crib_min: 12,
    crib_max: 22,
    car_seat_min: 25,
  ...
  // SEO
  seo_title: 'Baby Equipment Rentals in Antigua and Barbuda | TopTours.ai',
  seo_description: 'Rent baby equipment in Antigua and Barbuda: strollers, car seats, cribs, and more delivered to your hotel or vacation rental. Clean, safe, and insured gear from BabyQuip.',
  seo_keywords: [
    'baby equipment rental Antigua and Barbuda',
    'baby gear rental Antigua and Barbuda',
    'stroller rental Antigua and Barbuda',
    'car seat rental Antigua and Barbuda',
    'crib rental Antigua and Barbuda',
    'baby equipment Antigua and Barbuda',
    'baby gear rental Antigua',
    'baby equipment rental Barbuda',
  ],
  
  is_active: true,
};

async function seedAntiguaAndBarbuda() {
  try {
    console.log('🌱 Seeding Antigua and Barbuda baby equipment rentals data...');
    
    // Upsert data into Supabase
    const { data, error } = await supabase
      .from('baby_equipment_rentals')
      .upsert({
        destination_id: antiguaAndBarbudaData.destination_id.toLowerCase(),
        hero_title: antiguaAndBarbudaData.hero_title || null,
        hero_description: antiguaAndBarbudaData.hero_description || null,
        hero_tagline: antiguaAndBarbudaData.hero_tagline || null,
        product_categories: antiguaAndBarbudaData.product_categories ? JSON.parse(JSON.stringify(antiguaAndBarbudaData.product_categories)) : null,
        intro_text: antiguaAndBarbudaData.intro_text || null,
        rates_note: antiguaAndBarbudaData.rates_note || null,
        faqs: antiguaAndBarbudaData.faqs ? JSON.parse(JSON.stringify(antiguaAndBarbudaData.faqs)) : null,
        pricing_info: antiguaAndBarbudaData.pricing_info ? JSON.parse(JSON.stringify(antiguaAndBarbudaData.pricing_info)) : null,
        seo_title: antiguaAndBarbudaData.seo_title || null,
        seo_description: antiguaAndBarbudaData.seo_description || null,
        seo_keywords: antiguaAndBarbudaData.seo_keywords || null,
        is_active: antiguaAndBarbudaData.is_active !== undefined ? antiguaAndBarbudaData.is_active : true,
      }, {
    ...
    if (error) {
      console.error('❌ Error seeding Antigua and Barbuda data:', error);
      console.error('Error details:', JSON.stringify(error, null, 2));
      process.exit(1);
    }
    
    console.log('✅ Successfully seeded Antigua and Barbuda baby equipment rentals!');
