...
export default function RestaurantPromotionCard({ restaurantId, initialScore = null, compact = false, restaurantData = null, destinationId = null }) {
  ...
  const loadScore = async () => {
    try {
      ...
      console.error('Error loading restaurant score:', error);
    } finally {
  ...
  const handleSpendPoints = async () => {
    if (!account) {
      toast({
        ...
        description: 'Please sign in to promote restaurants with your daily points.',
        variant: 'destructive',
      });
      setShowModal(false);
      return;
    ...
    try {
      setIsSpending(true);
      // Add destination_id to restaurantData if provided
      const enhancedRestaurantData = destinationId && restaurantData 
        ? { ...restaurantData, destination_id: destinationId }
        : restaurantData;
      ...
      const response = await fetch('/api/internal/promotion/restaurant-spend', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          points: points,
          scoreType: 'all',
          restaurantData: enhancedRestaurantData,
        }),
      });
  ...
  const handleALaCartePurchase = async (packageName) => {
    ...
    try {
      ...
      const returnUrl = typeof window !== 'undefined' 
        ...
        : restaurantData?.slug && destinationId
          ? `https://toptours.ai/destinations/${destinationId}/restaurants/${restaurantData.slug}`
          : null;
  ...
  // Don't render if restaurantId is missing
  if (!restaurantId) {
    return null;
  }
            ...
            >
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">Boost This Restaurant</h3>
                </div>
              ...
              {accountLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <p className="text-xs text-gray-600 mb-3">
                      One-time purchase — points apply immediately to this restaurant
                    </p>
                    <div className="space-y-2">
                ...
                <div className="text-center py-4">
                  <p className="text-sm text-gray-600 mb-4">
                    Sign in to boost this restaurant with your daily points
                  </p>
                  <a
                    href="/auth"
