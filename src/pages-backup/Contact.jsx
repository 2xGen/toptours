...
const Contact = () => {
  ...
  const structuredData = {
    ...
    "description": "Get in touch with TopTours.ai through social media or email. We're here to help with your travel planning needs.",
    ...
    "mainEntity": {
      ...
      "contactPoint": [
        ...
        },
        {
          ...
          "url": "https://www.facebook.com/profile.php?id=61573639234569"
        },
        {
          "@type": "ContactPoint",
          "contactType": "social media", 
          "url": "https://www.instagram.com/toptours.ai/"
        },
        {
          "@type": "ContactPoint",
          "contactType": "social media",
          "url": "https://www.tiktok.com/@toptours.ai"
        }
      ]
    }
  };
  ...
  return (
    <>
      <Helmet>
        <title>Contact TopTours.ai - Get in Touch for Travel Planning Help</title>
        <meta name="description" content="Contact TopTours.ai through social media or email. We're here to help with your travel planning questions and provide personalized tour recommendations." />
        <meta name="keywords" content="contact TopTours.ai, travel planning help, tour booking support, customer service, travel assistance" />
        <link rel="canonical" href="https://toptours.ai/contact" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Contact TopTours.ai - Get in Touch for Travel Planning Help" />
        <meta property="og:description" content="Contact TopTours.ai through social media or email. We're here to help with your travel planning questions and provide personalized tour recommendations." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://toptours.ai/contact" />
        ...
        <meta name="twitter:title" content="Contact TopTours.ai - Get in Touch for Travel Planning Help" />
        <meta name="twitter:description" content="Contact TopTours.ai through social media or email for travel planning assistance." />
